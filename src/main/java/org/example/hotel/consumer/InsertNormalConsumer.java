 ...
 */
@Service
@RocketMQMessageListener(consumerGroup = "spring-boot-push-consumer-normal", topic = "spring-boot-normal-topic", tag = "insert")
public class InsertNormalConsumer implements RocketMQListener {

    Logger logger = LoggerFactory.getLogger(InsertNormalConsumer.class);
    ...
    public ConsumeResult consume(MessageView messageView) {
        logger.info("insert received message:{}", messageView);
        // 获取消息体 ByteBuffer
        ...
        // 处理消息
        hotelService.save(Long.parseLong(messageBody));
